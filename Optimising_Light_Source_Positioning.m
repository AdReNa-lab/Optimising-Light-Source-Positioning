...
Illuminated_Area_Limits = [X_limit, X_Resolution, Y_limit, Y_Resolution];
...
Standard_Deviation_Tolerance = 5*10^-7;
...
Plot_Save_Results(Illumination_Data_Reduced, Plotted_Area_Limits, Illuminated_Area_Limits, Far_Field_Data, Camera_Height);
