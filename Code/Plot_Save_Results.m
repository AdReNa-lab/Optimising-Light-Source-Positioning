function Plot_Save_Results(Illumination_Data_Reduced, Plotted_Area_Limits, Illuminated_Area_Limits, Far_Field_Data, Camera_Position)
...
for option = 1:number_combinations
    ...
    std_perc = Illumination_Data_Reduced.standard_deviation_percentage(option);
...
%optional limit for colorbar axis
%caxis([0 15*10^-5])
